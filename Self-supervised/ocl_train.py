...
Only runtime/data-source selection lives here.  OCL view generation and loss
remain in ``models.ocl_head.OCLHead3D`` unchanged.
"""
...
def main() -> None:
    ...
    while global_step < args.num_steps:
        ...
        for batch in train_loader:
            ...
            started = time()
            img_views, labels, _ = batch
            img = concat_image(img_views).to(args.device, non_blocking=True)
